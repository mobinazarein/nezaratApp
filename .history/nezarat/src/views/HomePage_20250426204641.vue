          ...
          <ion-segment value="all" @ionChange="segmentChanged" style="background-color: #FFFFFF;">
            <ion-segment-button value="all">
              <div style="display: flex;">
                <ion-label
                  style="background-color: #A2845E66;color: #A2845E;width: 41px;height: 31px;display: flex;align-items: center;justify-content: center;border-radius: 40px;font-size:   14px;">
                  334</ion-label>
