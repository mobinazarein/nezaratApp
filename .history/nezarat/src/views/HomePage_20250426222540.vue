...
.table-container {
  height: 500px;
  /* یا مثلاً height: 100% اگر والدش ارتفاع دارد */
  overflow: hidden;
...
.custom-table tbody {
  flex-grow: 1;
  /* تمام فضای باقیمانده را پر کند */
  overflow-y: auto;
  /* اگر محتوا زیاد شد، اسکرول شود */
}

.custom-table tr {
  height: 30px !important;
  /* ارتفاع هر ردیف دقیقاً 30px */
  display: flex;
}
