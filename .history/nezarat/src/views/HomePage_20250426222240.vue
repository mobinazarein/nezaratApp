...
.custom-table {
  ...
  /* ارتفاع کامل */
  display: block;
  /* برای اعمال height نیاز داریم */
  overflow: hidden;
  /* از بیرون زدن محتوا جلوگیری می‌کند */
}
...
.custom-table tbody {
  overflow-y: auto;
  /* اگر محتوا زیاد شد اسکرول ایجاد شود */
  height: calc(100% - 40px);
  /* ارتفاع تیبل منهای ارتفاع هدر */
}
...
.custom-table td {
  ...
  justify-content: center;
  min-width: 0;
  /* برای جلوگیری از گسترش سلول‌ها */
  height: 30px;
  /* ارتفاع ثابت برای سلول‌ها */
  box-sizing: border-box;
  /* padding و border در ارتفاع محاسبه شود */
}

.custom-table thead {
  background-color: #F6F8FA;
  height: 40px;
  /* ارتفاع هدر کمی بیشتر */
}
