      ...
      <div style="display: flex;align-items: center;justify-content: space-between;">
        ...
        <div>
          <div style="display: flex;align-items: center;justify-content: center;">
            <p>مدیر ارشد</p>
            <div
              style="width: 40px;height:40px ;background-color: #A2845E;text-align: center;color: white;display: flex;align-items: center;justify-content: center;border-radius:px ;">
              م‌ا
            </div>
          </div>
        </div>
